...
class ConvSearchEvaluation:
    ...
    def __init__(self):
        ...
        # Test topics
        with open("/scratch/treccastweb/2019/data/evaluation/evaluation_topics_v1.0.json", "rt", encoding="utf-8") as f: 
            self.test_topics = json.load(f)

        # fields: topic_turn_id, docid, rel
        self.test_relevance_judgments = pd.read_csv("/scratch/treccastweb/2019/data/evaluation/evaluation_topics_mod.qrel", sep=' ', names=["topic_turn_id", "dummy", "docid", "rel"])
